...
describe('SearchService', () => {
  ...
  context('getResults', () => {
    ...
    it('should call store.commit SET_RESULTS with file and count when search succeeds', ()=> {
      const file1 = {content: 'search for this'}
      const file2 = {content: 'search for this, search for this'}
      gettersStub.value({
    ...
    it('should call store.commit SET_RESULTS with empty array when search fails', ()=> {
      const file1 = {content: 'searchterm is not here'}
      const file2 = {content: 'searchterm is not here'}
      gettersStub.value({
        'pages/visibleFiles': (page) => [file1, file2]
      })
      SearchService.getResults('search for this', 'pageType')
